 ...
 * SP3マルチ動画キャンペーン リトライ
 * - 動画は既にアップロード済み
 * - UTAGEパス CR00598 作成済み
 * - campaign作成でbudget_optimize_on:trueで再試行
 */
...
// SP3にアップロード済みの23動画
const SP3_VIDEO_IDS = [
  'v10033g50000d7aghp7og65jm8eun9jg',
  'v10033g50000d7aghrfog65lvohfp0sg',
  'v10033g50000d7aghtvog65q2b04iodg',
  'v10033g50000d7agi17og65lbb4qi6fg',
  'v10033g50000d7agi3fog65kc5cr05u0',
  'v10033g50000d7agi6vog65kml799790',
  'v10033g50000d7agia7og65mkk95eerg',
  'v10033g50000d7agidfog65g6rpfvqvg',
  'v10033g50000d7agihfog65i8549kdmg',
  'v10033g50000d7agikvog65jt7hhd850',
  'v10033g50000d7agionog65o5m680a20',
  'v10033g50000d7agirvog65hrk0avasg',
  'v10033g50000d7agivvog65vhipenms0',
  'v10033g50000d7agj47og65nldlb3ong',
  'v10033g50000d7agj7fog65kg6hsdvbg',
  'v10033g50000d7agjbfog65hlou5qt80',
  'v10033g50000d7agjenog65knkierukg',
  'v10033g50000d7agjhvog65h2e93fa10',
  'v10033g50000d7agjkvog65ktneagjbg',
  'v10033g50000d7agjo7og65nge2a7hpg',
  'v10033g50000d7agjqvog65jie3ujdr0',
  'v10033g50000d7agjufog65r1p516i10',
...
async function main() {
  ...
  try {
    ...
    try {
      ...
      console.log(`CBO有効失敗: ${e.message}`);
    }

    // 方法2: budget_optimize_onなしで試行
    console.log('\n--- budget_optimize_onなしで試行 ---');
    try {
      const data = await tiktokApi('/v1.3/smart_plus/campaign/create/', {
        advertiser_id: SP3,
        campaign_name: AD_NAME + '_v2',
        objective_type: 'LEAD_GENERATION',
        request_id: String(Date.now()) + String(Math.floor(Math.random() * 100000)),
      });
      const campaignId = String(data.data.campaign_id);
