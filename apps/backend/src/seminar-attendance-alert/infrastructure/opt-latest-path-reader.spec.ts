  ...
  it('ファネル登録経路空でもURLから抽出', () => {
    const rows = [
      ...
      [
        ...
        'bar@example.com',
        '',
        'https://x/p/a?utm_campaign=260404%2F%E6%A8%AA%E5%B1%95%E9%96%8B%2FCR454_%E6%A8%AA%E5%B1%95%E9%96%8B%2FLP1-CR01147',
        '',
        '2026-04-01 10:00:00',
      ],
    ];
