...
describe('ProfitSimulation', () => {
  describe('calculateProfitSimulation', () => {
    it('日割り計算で月末着地を推定する', () => {
      ...
      const expectedProjectedProfit =
        expectedProjectedRevenue - expectedProjectedAdSpend;
  ...
  describe('calculateTotalProfitSummary', () => {
    it('全導線のサマリーを算出する', () => {
      const channels: ProfitSimulation[] = [
        {
          ...
          totalDaysInMonth: 31,
          projectedAdSpend: 3_840_887,
          projectedRevenue: 5_337_610,
          projectedProfit: 1_496_723,
          targetProfit: 20_000_000,
          gapToTarget: -18_503_277,
          isOnTrack: false,
        },
        {
          channelType: 'SNS',
          period: { year: 2026, month: 3 },
          actualDays: 21,
          actualAdSpend: 328_789,
          actualRevenue: 1_659_040,
          actualProfit: 1_330_251,
          totalDaysInMonth: 31,
          projectedAdSpend: 485_403,
          projectedRevenue: 2_449_059,
          projectedProfit: 1_963_656,
          targetProfit: 10_000_000,
          gapToTarget: -8_036_344,
          isOnTrack: false,
        },
        {
          ...
          period: { year: 2026, month: 3 },
          actualDays: 21,
          actualAdSpend: 1_080_256,
          actualRevenue: 5_637_000,
          actualProfit: 4_556_744,
          totalDaysInMonth: 31,
          projectedAdSpend: 1_594_664,
          projectedRevenue: 8_321_000,
          projectedProfit: 6_726_336,
          targetProfit: 10_000_000,
          gapToTarget: -3_273_664,
          isOnTrack: false,
        },
      ];

      const summary = calculateTotalProfitSummary(channels, {
        year: 2026,
        month: 3,
      });
      ...
      expect(summary.totalProjectedProfit).toBe(
        1_496_723 + 1_963_656 + 6_726_336,
      );
      expect(summary.totalTargetProfit).toBe(
        20_000_000 + 10_000_000 + 10_000_000,
      );
      ...
      const channels: ProfitSimulation[] = [
        {
          ...
          period: { year: 2026, month: 3 },
          actualDays: 31,
          actualAdSpend: 1_000_000,
          actualRevenue: 25_000_000,
          actualProfit: 24_000_000,
          totalDaysInMonth: 31,
          projectedAdSpend: 1_000_000,
          projectedRevenue: 25_000_000,
          projectedProfit: 24_000_000,
          targetProfit: 20_000_000,
          gapToTarget: 4_000_000,
          isOnTrack: true,
        },
      ];
