...
export const TIKTOK_FUNNEL_MAP: Record<string, Record<number, FunnelConfig>> = {
  AI: {
    1: {
      funnelId: 'a09j9jop95LF',
      groupId: 'EFnsGw3gAdba',
      stepId: 'r2RHcL0PdGIY',
    },
    2: {
      funnelId: 'a09j9jop95LF',
      groupId: 'bvnhWMTjQAPU',
      stepId: 'EnFeDysozIui',
    },
    3: {
      funnelId: 'a09j9jop95LF',
      groupId: 'EZL6dqvMuop6',
      stepId: 'A65xiRBl9HCD',
    },
    4: {
      funnelId: 'a09j9jop95LF',
      groupId: 'hEwR9BcvprDu',
      stepId: 'T8RHcXJVzGtY',
    },
    5: {
      funnelId: 'a09j9jop95LF',
      groupId: 'ND7cXzKmeiqG',
      stepId: 'EIQBI7HAVxgd',
    },
    6: {
      funnelId: 'a09j9jop95LF',
      groupId: 'FNFK0iB3rIzl',
      stepId: 'U8Ba9qy5m0us',
    },
  },
  SNS: {
    1: {
      funnelId: 'dZNDzwCgHNBC',
      groupId: '32FwkcHtFSuj',
      stepId: 'wZhilaQY1Huv',
    },
    2: {
      funnelId: 'dZNDzwCgHNBC',
      groupId: 'dLrB2E7U7tq8',
      stepId: 'AhTvtpaeXyj6',
    },
    3: {
      funnelId: 'dZNDzwCgHNBC',
      groupId: 'L9JO3krgnNYD',
      stepId: '5UKZIXOKSyV4',
    },
    4: {
      funnelId: 'dZNDzwCgHNBC',
      groupId: 'JBy6Obcrng4Z',
      stepId: 'IxX853OXYhz2',
    },
  },
  スキルプラス: {
    2: {
      funnelId: '3lS3x3dXa6kc',
      groupId: 'sOiiROJBAVIu',
      stepId: 'doc7hffUAVTv',
    },
  },
};
...
export const OPERATOR_LOGIN_URL =
  'https://school.addness.co.jp/operator/GYbKT7Y9d0eR/login';
...
export const DEEP_FUNNEL_CONFIG: Record<
  string,
  | { deepExternalAction?: string; deepFunnelOptimizationEvent?: string }
  | undefined
> = {
